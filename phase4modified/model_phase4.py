...
from round_manager_phase4 import *
...
class ZumaModelPhase4:
    def __init__(self, phase4_info: Phase4Info):
        ...
        self._colors_str: list[str] = phase4_info['colors']
        self._rounds: dict[str, RoundInfo] = phase4_info['rounds']
        self._round_manager: RoundManager = RoundManager(self._grid_size, self._rounds["1"], phase4_info["colors"])

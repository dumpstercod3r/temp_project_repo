...
from model_phase4 import ZumaModelPhase4, GameState
from view_phase4 import ZumaViewPhase4

class ZumaControllerPhase4:
    def __init__(self, model: ZumaModelPhase4, view: ZumaViewPhase4):
        self._model: ZumaModelPhase4 = model
        self._view: ZumaViewPhase4 = view

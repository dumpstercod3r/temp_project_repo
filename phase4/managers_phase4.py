...
class RoundManager:
    def __init__(self, grid_size: list[int], round_info: RoundInfo):
        self._round_info: RoundInfo = round_info
        self._curr_round: int = 1
        self._grid_size: list[int] = grid_size
        self._rng: Random = Random(67) # for testing
        ...
        self._round_state: RoundState = RoundState.ROUND_SETUP
        self._map_manager: MapManager = MapManager(grid_size, round_info["tunnel_coords"], round_info["enemy_paths"])
    ...
    def prepare_round(self, round_info: RoundInfo):
...
class MapManager:
    def __init__(self, grid_size: list[int], tunnel_coords: list[list[int]], raw_enemy_paths: list[list[list[int]]]):
        ...
        self.prepare_round(tunnel_coords, raw_enemy_paths)
    ...
    def prepare_round(self, tunnel_coords: list[list[int]], raw_enemy_paths: list[list[list[int]]]):
        self._grid: Grid = []

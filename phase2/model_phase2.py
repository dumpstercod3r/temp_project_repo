...
from common_types_phase2 import *
from managers_phase2 import *
...
class ZumaModelPhase2:
    def __init__(self, phase2_info: Phase2Info):
        ...
        self._enemy_manager: EnemyManager = EnemyManager(phase2_info['enemy_count'], phase2_info['enemy_types'], self._colors)
        self._bullet_manager: BulletManager = BulletManager(self._colors, phase2_info['grid_size'])
